...
export default function Home() {
  return (
    <div
      className={`${geistSans.className} ${geistMono.className} grid grid-rows-[20px_1fr_20px] bg-white tems-center justify-items-center min-h-screen pt-20 pb-20 gap-16 font-[family-name:var(--font-geist-sans)]`}
    >
      ...
      <footer className="flexJIC w-full row-start-3 pb-32 pt-20 bg-[var(--background)]">
        <div className="flex items-center justify-evenly w-full pt-12 pl-5 pr-5">
          ...
          <div className="flex items-start justify-center flex-col">
            <div className="flex items-start justify-center flex-col text-2xl text-[var(--tw3blue)]">
              <span>
          ...
          <div className="flex justify-center items-end flex-col gap-2 text-[9px]">
            <div className="flexJIC gap-4 text-[var(--tw3grey)]">
